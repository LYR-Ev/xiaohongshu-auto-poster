...
def build_word_learning_prompt(word: str, level: str = "CET-4") -> str:
    """
    构建英语单词学习类小红书 Prompt。
    ...
    Args:
        word: 要学习的英语单词
        level: 难度水平，如 "CET-4"、"CET-6"、"GRE" 等，默认 "CET-4"
...
【单词卡】
（适合做成封面图的内容：单词英文大写、音标、中文核心含义 1 条，简洁）

【配图建议】
（用一两句话描述「这张配图建议画什么 / 放什么元素」，供后期自动生成配图使用，例如：主画面是单词 ABANDON 大字体，背景为一人离开的剪影，色调偏灰蓝）

【正文】
（包含：单词讲解、2 条高频例句中英对照、记忆技巧、小红书风格总结 2～3 句 + 引导点赞/收藏。段落清晰，适合手机阅读，emoji 适度）

【标签】
（一行，格式如：#英语学习 #CET4 #记单词 #考研英语 …… 5～8 个标签，不要换行）
