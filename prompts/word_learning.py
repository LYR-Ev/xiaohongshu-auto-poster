...
(注意要适当换行，不要让单词卡内容过长，影响阅读体验。也不要输出包括这句话在内的无关信息，不要出现任何解释说明)

【配图建议】
（用一两句话描述「这张配图建议画什么 / 放什么元素」，供后期自动生成配图使用，例如：主画面是单词 abandon 小字体）

【必选】实用例句：至少 2 条例句，每条必须中英文对照（先英文句子，后跟中文翻译，缺一不可,保证例句里面有该单词）。

【必选】相关词汇扩展：英语单词+中文释义，2-3个

【必选】小红书风格总结：2～3 句 + 引导点赞/收藏。

【标签】
（一行，必须按照一下格式：#英语学习  #CET6  #记单词  #考研英语 …… 10 个标签，不要换行，务必不要重复，务必不要出现与英语学习无关的话题标签，务必不要有多余的#号）
